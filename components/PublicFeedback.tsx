...
export const PublicFeedback: React.FC<PublicFeedbackProps> = ({ onSubmit }) => {
  ...
  return (
    <div className="w-full bg-white/10 backdrop-blur-xl rounded-[30px] md:rounded-[40px] shadow-2xl overflow-hidden border border-white/10 flex flex-col md:flex-row-reverse">
